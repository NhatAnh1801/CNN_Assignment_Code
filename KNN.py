...
knn_predictions = knn.predict(test_images_pca)

# Calculate accuracy
knn_accuracy = accuracy_score(test_labels.ravel(), knn_predictions)
...
print(f'KNN Training and Prediction Time: {total_time:.2f} seconds')
